...
ruleset=🖥️ PT,https://raw.githubusercontent.com/bujinbufa/clash-/main/rule/Clash/PrivateTracker/PrivateTracker.list
ruleset=🖥️ PT,https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Speedtest/Speedtest.list
...
custom_proxy_group=🎮 Game`select`[]DIRECT`[]🎮 游戏节点`[]其他节点`[]IPLC`[]🇸🇬 狮城节点`[]🇭🇰 香港节点`[]🇨🇳 台湾节点`[]🇯🇵 日本节点`[]🇺🇲 美国节点`[]🇰🇷 韩国节点`[]🚀 手动切换
  custom_proxy_group=🖥️ PT`select`[]DIRECT`[]🇭🇰 香港节点`[]🇨🇳 台湾节点`[]🇸🇬 狮城节点`[]🇯🇵 日本节点`[]🇺🇲 美国节点`[]🇰🇷 韩国节点`[]🚀 手动切换`[]其他节点`[]IPLC
